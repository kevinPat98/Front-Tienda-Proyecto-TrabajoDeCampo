        ...
        if(response.venta){
          ...
          let data = {
            ...
            back_urls: {
                ...
                COPding: "http://localhost:5000/verificar-pago/COPding/"+this.direccion_envio._id+'/'+this.venta.cupon+'/'+this.envio+'/'+this.tipo_descuento+'/'+this.valor_descuento+'/'+this.total_pagar+'/'+this.subtotal,
